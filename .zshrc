# Zsh初心者がzshrcを色々調べたの晒してみる@qiita
# -----------------------------
# Lang
# -----------------------------
...
__conda_setup="$('/home/sakakazu2468/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/sakakazu2468/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/sakakazu2468/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/sakakazu2468/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
